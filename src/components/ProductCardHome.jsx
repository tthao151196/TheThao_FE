...
const SOFT_GRADIENT = "linear-gradient(135deg,#a5b4fc 0%,#93c5fd 45%,#67e8f9 100%)";
const INK = "#0b1220", MUTED = "#475569", SALE = "#e11d48", CONTACT = "#2563eb";
...
export default function ProductCardHome({ p }) {
  ...
  return (
    <Link to={`/products/${p.id}`} style={{ textDecoration: "none", color: "inherit" }}>
      <article
        style={{
          background: "#fff", borderRadius: 16, border: "1px solid rgba(2,6,23,.06)",
          boxShadow: "0 8px 24px rgba(2,6,23,.08)", overflow: "hidden",
        ...
        <div style={{ height: 190, background: "#f1f5f9", position: "relative", overflow: "hidden" }}>
          {hasSale && (
            <span style={{
              ...
              background: "linear-gradient(180deg,#ff7a18,#ff3d00)", color: "#fff",
              fontWeight: 900, fontSize: 13, padding: "6px 10px",
              borderRadius: 999, boxShadow: "0 2px 6px rgba(0,0,0,.18)",
            }}>
              -{discount}%
            </span>
          )}
        ...
        <div style={{ display: "flex", flexDirection: "column", padding: 0, flex: 1 }}>
          <div
            style={{
              ...
              color: INK, padding: "12px 12px 14px", gap: 6, display: "flex",
              flexDirection: "column", flex: 1, borderTop: "1px solid rgba(2,6,23,.06)",
              borderRadius: "0 0 16px 16px",
            }}
          >
            <h3 style={{
              fontSize: 16, fontWeight: 900, lineHeight: 1.35, margin: 0, color: INK,
            ...
            <div style={{
              color: MUTED, fontSize: 13, whiteSpace: "nowrap", overflow: "hidden",
              textOverflow: "ellipsis", minHeight: 18, fontWeight: 800,
            }} title={p.brand_name || ""}>
              {p.brand_name || "—"}
            </div>
            ...
            <div style={{ marginTop: "auto" }}>
              ...
              {hasSale && (
                <div style={{
                  color: "#94a3b8", textDecoration: "line-through", marginTop: 2, fontWeight: 800,
                }}>
